...
### Step 5: Define Policy for User-Specific Access
...
## Part 1. Summary
Covered IAM, users, groups and policies management in AWS. Implemented user setup, configured S3 buckets, and applied policies using the AWS CLI script.
...
## Step 1: Setting Up Our Working Environment with Cloudformation.
...
6. Write a policy using provided ![JSON file](https://github.com/DimitryZH/AWS-IAM/blob/main/role-policy.json)
7. Attach a role to a policy.
8. Review and create the policy.

## Step 3: Testing the Service Role
